...
public class NightDeal {
    public static void main(String[] args) {
        ExcelReader reader = ExcelUtil.getReader(ConstPath.path+"\\night_high_sti.xlsx");
        ...
        ExcelWriter writer = ExcelUtil.getWriter(ConstPath.path+"\\night_high_sti_cal.xlsx");

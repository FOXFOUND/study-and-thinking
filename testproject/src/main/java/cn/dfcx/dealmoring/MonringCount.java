...
public class MonringCount {
    public static void main(String[] args) {
        ExcelReader reader = ExcelUtil.getReader(ConstPath.path+"\\morning_high_sti.xlsx");
        ...
        ExcelWriter writer = ExcelUtil.getWriter(ConstPath.path+"\\morning_hight_sti_cal.xlsx");
